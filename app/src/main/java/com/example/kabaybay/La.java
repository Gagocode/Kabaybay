...
public class La extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.la);
        ...
        final MediaPlayer mmp = MediaPlayer.create(this, R.raw.le_li);
        ...
        final MediaPlayer mpp = MediaPlayer.create(this, R.raw.lo_lu);
