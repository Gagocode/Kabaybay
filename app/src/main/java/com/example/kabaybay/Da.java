...
public class Da extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.da);
        ...
        final MediaPlayer mmp = MediaPlayer.create(this, R.raw.de_di);
        ...
        final MediaPlayer mpp = MediaPlayer.create(this, R.raw.do_du);
